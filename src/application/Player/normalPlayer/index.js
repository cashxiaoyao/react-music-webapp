 ...
 * @version: X3版本
 * @Author: Cash
 * @Date: 2021-04-21 13:16:57
 * @LastEditors: Cash
 * @LastEditTime: 2021-04-22 17:00:56
 */
...
function NormalPlayer(props) {
    ...
    const { toggleFullScreen, onProgressChange, clickPlaying, handleNext, handlePrev, changeMode } = props
    ...
    const enter = () => {
        ...
        const { x, y, scale } = _getPosAndScale() // 获取miniPlayer图片的中心相对normalPlayer唱片中心的偏移
        let animation = {
            0: {
            ...
            <NormalPlayerContainer ref={normalPlayerRef}>
                ...
                <Middle>
                    <CDWrapper ref={cdWrapperRef}>
                        <div className="cd">
                            <img src={`${song.al.picUrl}?param=400x400`} alt="" className={`image play ${playing ? '' : 'pause'}`} />
                        </div>
                    </CDWrapper>
                </Middle>
