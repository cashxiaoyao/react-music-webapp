...
import { ImgWrapper, CollectButton, SongListWrapper, BgLayer, Container } from "./style";
...
function Singer(props) {
    ...
    const songs = songsOfArtist.toJS();
...
const mapStateToProps = (state) => {
    return {
        artist: state.getIn(['songerInfo', 'artist']),
        songsOfArtist: state.getIn(['songerInfo', 'songsOfArtist']),
        loading: state.getIn(['songerInfo', 'loading'])
    }
}
